 ...
 * 
 * EXAMPLE: node redis_performance_monitor.js "1,1,1,1" "10.10.2.5" "6379" "username" "password"
 *
 * README:
 ...
 */
var metrics = [];
metrics['ConnectionsPerSecond'] 	= { id : '9999:Connections/Sec:99', 			key : 'total_connections_received', ratio : true };
metrics['ConnectedClients'] 		= { id : '9999:Connected Clients:99', 			key : 'connected_clients', 			ratio : false };
metrics['BlockedClients']		 	= { id : '9999:Blocked Clients:99', 			key : 'blocked_clients', 			ratio : false };
metrics['UsedMemory'] 				= { id : '9999:Used Memory:99', 				key : 'used_memory', 				ratio : false };
metrics['CommandsPerSecond'] 		= { id : '9999:Commands/Sec:99', 				key : 'total_commands_processed', 	ratio : true };
metrics['KeyHits'] 					= { id : '9999:Key Hits:99', 					key : 'keyspace_hits', 				ratio : false };
metrics['KeyMisses'] 				= { id : '9999:Key Misses:99', 					key : 'keyspace_misses', 			ratio : false };
metrics['KeysEvicted'] 				= { id : '9999:Keys Evicted:99', 				key : 'evicted_keys', 				ratio : false };
metrics['KeysExpired'] 				= { id : '9999:Keys Expired:99', 				key : 'expired_keys', 				ratio : false };
metrics['BackgroundSaveInProgress'] = { id : '9999:Background save in Progress:99', key : 'rdb_bgsave_in_progress', 	ratio : false };
metrics['ChangesSinceLastSave'] 	= { id : '9999:Changes since last Save:99', 	key : 'rdb_changes_since_last_save', ratio : false };
metrics['ConnectedSlaves'] 			= { id : '9999:Connected Slaves:99', 			key : 'connected_slaves', 			ratio : false };
	...
	client.info(function(err, data) {
		...
		for(var key in metrics)
		{
			if (request.checkMetrics[i])
			{
				...
				jsonString += '"value":"' + data[metric.key] + '"';
				jsonString += '},';
			}
			i++;
		}
